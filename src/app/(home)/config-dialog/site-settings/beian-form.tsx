...
export function BeianForm({ formData, setFormData }: BeianFormProps) {
	return (
		<div className='space-y-2'>
			<label className='mb-2 block text-sm font-medium'>ICP filing</label>
			<div className='grid grid-cols-2 gap-2'>
				<div>
					<label className='mb-1 block text-xs text-gray-600'>ICP number</label>
					<input
						type='text'
				...
				<div>
					<label className='mb-1 block text-xs text-gray-600'>ICP link (optional)</label>
					<input
						type='url'
