		...
		<div className='space-y-6'>
			...
			<div className='flex gap-3'>
				<label className='flex items-center gap-2'>
					...
					/>
					<span className='text-sm font-medium'>Show seconds on clock</span>
				</label>
			...
			<div className='flex gap-3'>
				<label className='flex items-center gap-2'>
					<input
						...
						className='accent-brand h-4 w-4 rounded'
					/>
					<span className='text-sm font-medium'>Cache PEM (encrypted, but still risky)</span>
				</label>
				<label className='flex items-center gap-2'>
					<input
						type='checkbox'
						...
						className='accent-brand h-4 w-4 rounded'
					/>
					<span className='text-sm font-medium'>Enable article categories</span>
				</label>
				<label className='flex items-center gap-2'>
					<input
						type='checkbox'
						...
						className='accent-brand h-4 w-4 rounded'
					/>
					<span className='text-sm font-medium'>Enable Christmas theme</span>
				</label>
			</div>
