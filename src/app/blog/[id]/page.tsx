...
export default function Page() {
	...
	const date = useMemo(() => dayjs(blog?.config.date).format('MMMM D, YYYY'), [blog?.config.date])
	...
	if (!blog) {
		return <div className='text-secondary flex h-full items-center justify-center text-sm'>Article not found</div>
	}
