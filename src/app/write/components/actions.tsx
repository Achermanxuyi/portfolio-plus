...
export function WriteActions() {
	...
	const handleDelete = () => {
		if (!isAuth) {
			toast.info('Please import a key first')
			return
		}
		const confirmMsg = form?.title ? `Delete “${form.title}”? This cannot be undone.` : 'Delete the current article? This cannot be undone.'
